...
| S20 | `valence` envelope       | `[start,end] 0–1`                    | absent (arousal+dance only)             | per preset                    | 🔨 planned (B4)                     | preset gains the field; dark arc for afterhours                                                                   |
...
| T8  | `valence`                                        | `mood`                                       | `number \| null` (1–9) | unused               | 🔶 B4      | dead data today — becomes 3rd fit axis                                       |
...
| T11 | phrase cues (8-bar)                              | `cues`                                       | `cues_json`            | absent → no handoff  | 🔶 Phase D | mixOut/mixIn windows — the bet                                               |
...
| T14 | LUFS                                             | **not stored**                               | `number`               | —                    | 🔮 B11p    | `megadj loudness` pass; continuity penalty                                   |
...
| T17 | mood heads (`aggressive/happy/electronic/party`) | `mood`                                       | `number`               | unused               | 🔶 later   | possible preset guards (party→peak etc.)                                     |
...
| T21 | vocal presence                                   | **not stored**                               | `number`               | —                    | ❌ for now | needs Demucs pass; revisit only if Phase D windows demand it                 |

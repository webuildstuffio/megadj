...
| Today                                                                                                                                                                               | After                                                                                                                                                                    | Files                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CLI verb `megadj setbuild`                                                                                                                                                          | `megadj megaset`                                                                                                                                                         | `src/cli-commands-analysis.ts` (handler const, registry entry, 3× `nonNegOpt` domain arg), `src/usage.ts:49,51,174` (usage line + help copy ×2)                                                                              |
...
| `parseSetbuildQuery`                                                                                                                                                                | `parseMegasetQuery`                                                                                                                                                      | `cratedeck/src/megaset.ts`, engine test, `src/rekordbox/rb-playlist.ts` (comment + import use), docs                                                                                                                         |
| `buildSet`                                                                                                                                                                          | `buildMegaset`                                                                                                                                                           | engine, rb-playlist.ts, tests, docs flow diagram                                                                                                                                                                             |
| Types `SetCandidate`, `SetBuildInput`, `SetBuildResult`, `SetBuildStep`, `SetBuildPayload`, `SetPresetId`, `SetPresetDef`, `SetPresetShape`                                         | `MegasetCandidate`, `MegasetInput`, `MegasetResult`, `MegasetStep`, `MegasetPayload`, `MegasetPresetId`, `MegasetPresetDef`, `MegasetPresetShape`                        | engine, `cratedeck/shared/megaset.ts`, `cratedeck/shared/types.ts` re-export leaf, rb-playlist.ts, web components + tests                                                                                                    |
...
| Components `SetBuildPanel`, `SetBuilderMethod`, `SetBuilderResult`; files `SetBuilderMethod.tsx`, `SetBuilderResult.tsx`                                                            | `MegasetPanel`, `MegasetMethod`, `MegasetResult`; `MegasetMethod.tsx`, `MegasetResult.tsx`                                                                               | `SimilarTab.tsx` (+ panel stays there; extraction is NOT in scope)                                                                                                                                                           |
...
| Default playlist name `setbuild ${preset} ${minutes}min ${date}`                                                                                                                    | `megaset ${preset} ${minutes}min ${date}`                                                                                                                                | `src/rekordbox/rb-playlist.ts:421` (+ its test)                                                                                                                                                                              |
...
| `docs/intake-cue-postmortem.md`, `docs/product-state-2026-09-07.md`, `docs/agent-playbook.md`                                                                                                                                                                                                                                                                                                                  | verify zero interface strings remain (prose already standardized)                                                                                                                                                                                               |
...
| `cratedeck/test/megaset.test.ts` (renamed)                     | every import + `describe("parseSetbuildQuery")`                                                                                                                                                                             |

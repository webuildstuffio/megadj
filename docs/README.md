...
- [MegaSet doc set](megaset/01-prd.md) — the set-builder product (PRD · architecture · 30-comparator analysis · [sequencing benchmarks](megaset/04-sequencing-benchmarks.md) · [genre audit](megaset/05-genre-audit.md)).

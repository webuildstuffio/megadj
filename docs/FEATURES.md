...
**Commands:** `megadj megaset --preset peak --minutes 60 [--opener <id>] [--search greedy|beam] [--genre FAMILY] [--json]` (the old `setbuild` verb is retired — unknown-command since #56) ·

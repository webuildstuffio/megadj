...
(the inbox-to-crate agent on top of the unbuilt `megadj drop`) and the
optional `claude -p` cron wrapper for the weekly digest.
...
| Zero manual labour | ingest→tagged→staged hands-free | components all exist; `megadj drop` glue unstarted |
...
*Evidence: [docs/docs-audit-2026-09-05.md](docs/docs-audit-2026-09-05.md)
(audit passes 1–4) · [docs/fulltags-roadmap.md](docs/fulltags-roadmap.md)
rev 6.2 (gates + execution log) ·
[docs/roadmap-proposal.md](docs/roadmap-proposal.md) (the three-move
proposal this page re-scores) · [docs/ideas.md](docs/ideas.md) §0 (the
gate that outranks all of it) · CHANGELOG [Unreleased].*

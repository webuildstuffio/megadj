...
Rev 27 · 2026-09-14 — MegaSet deep search + genre eval gate: (1) the
set-builder engine picks its sequencer by pool size (E7,
docs/megaset/04-sequencing-benchmarks.md) — pools under
`SET_BEAM_POOL_MAX = 250` run a beam-B=8 continuation, larger pools keep

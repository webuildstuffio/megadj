...
| HTTP API   | `src/deck/index.ts` + `api_routes.ts` (localhost:7742)       | 82 routes              |
| Web UI     | `src/deck/web/` (hash-routed pages)                              | 6 pages, 65 UI calls   |

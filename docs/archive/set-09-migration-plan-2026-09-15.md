...
> engine `src/deck/megaset.ts`, panel `MegasetPanel.tsx`, CSS
...
Execute only from a quiet worktree after the current integration batch is
complete (see "Concurrency pre-flight"). Companion docs: [PRD](01-prd.md) ·
...
1. `git status --short` — the migration touches files concurrent agents
   ...
   coordinated): `src/deck/setbuild.ts`, `src/deck/shared/setbuild.ts`,
   `src/deck/test/setbuild.test.ts`, `src/deck/web/products/fulltags/SimilarTab.tsx`,
   `src/rekordbox/rb-playlist.ts`, `src/cli-commands-analysis.ts`,
   `src/deck/shared/types.ts`, `src/deck/archive_routes.ts`,
   `src/deck/archive_tools.ts`, `docs/surface-parity.md`.
...
| HTTP route `GET /api/archive/setbuild` (+ `?format=m3u8`)                                                                                                                           | `GET /api/archive/megaset`                                                                                                                                               | `src/deck/archive_routes.ts` (9×), fetch URLs in `SimilarTab.tsx` (2×), surface test URLs                                                                                                                               |
| MCP tool `archive_set_build`                                                                                                                                                        | `megaset_propose`                                                                                                                                                        | `src/deck/archive_tools.ts` (5×), `src/deck/mcp.ts` (1×), `src/deck/deckctl.md`, SKILL.md, description text "M66 set-builder copilot" → "MegaSet copilot"                                                         |
| `parseSetbuildQuery`                                                                                                                                                                | `parseMegasetQuery`                                                                                                                                                      | `src/deck/setbuild.ts`, engine test, `src/rekordbox/rb-playlist.ts` (comment + import use), docs                                                                                                                        |
| `buildSet`                                                                                                                                                                          | `buildMegaset`                                                                                                                                                           | engine, rb-playlist.ts, tests, docs flow diagram                                                                                                                                                                             |
| Types `SetCandidate`, `SetBuildInput`, `SetBuildResult`, `SetBuildStep`, `SetBuildPayload`, `SetPresetId`, `SetPresetDef`, `SetPresetShape`                                         | `MegasetCandidate`, `MegasetInput`, `MegasetResult`, `MegasetStep`, `MegasetPayload`, `MegasetPresetId`, `MegasetPresetDef`, `MegasetPresetShape`                        | engine, `src/deck/shared/setbuild.ts`, `src/deck/shared/types.ts` re-export leaf, rb-playlist.ts, web components + tests                                                                                                   |
...
| Files `src/deck/setbuild.ts`, `src/deck/shared/setbuild.ts`, `src/deck/test/setbuild.test.ts`, `src/deck/test/archive-setbuild-surface.test.ts`, `src/fulltags/setbuild.ts` | `src/deck/megaset.ts`, `src/deck/shared/megaset.ts`, `src/deck/test/megaset.test.ts`, `src/deck/test/archive-megaset-surface.test.ts`, `src/fulltags/megaset.ts` | `git mv` only (keep the flat-file convention; no new folders)                                                                                                                                                                |
...
| `docs/set/01-prd.md`                                                                                                                                                                                                                                                                                                                                                                                       | `megadj setbuild` ×2, `GET /api/archive/setbuild`, `archive_set_build`, `parseSetbuildQuery`                                                                                                                                                                    |
| `docs/set/02-architecture.md`                                                                                                                                                                                                                                                                                                                                                                              | flow diagram (4 interface strings + `setbuild.ts` paths ×2, `SetBuildPayload` node)                                                                                                                                                                             |
| `docs/set/08-audit-and-plan.md`                                                                                                                                                                                                                                                                                                                                                                            | scope block file paths, `parseSetbuildQuery` ×2, `megadj setbuild` if present; add a header note: identifiers renamed per [09](09-migration-plan.md)                                                                                                            |
| `docs/set/04-sequencing-benchmarks.md`                                                                                                                                                                                                                                                                                                                                                                     | `src/deck/setbuild.ts` ×1                                                                                                                                                                                                                                  |
| `docs/fulltags/embedding-models.md` (moved from megaset/06)                                                                                                                                                                                                                                                                                                                                                | "MegaSet B10p" already fine; path refs updated to the new location                                                                                                                                                                                              |
| `docs/FEATURES.md`                                                                                                                                                                                                                                                                                                                                                                                         | `megadj setbuild` ×3                                                                                                                                                                                                                                            |
| `README.md`                                                                                                                                                                                                                                                                                                                                                                                                | `megadj setbuild` ×2                                                                                                                                                                                                                                            |
| `docs/ideas.md`                                                                                                                                                                                                                                                                                                                                                                                            | I66 block: engine path, route, MCP/CLI names                                                                                                                                                                                                                    |
| `src/deck/deckctl.md`                                                                                                                                                                                                                                                                                                                                                                                     | `archive_set_build` ×1                                                                                                                                                                                                                                          |
...
| `src/deck/web/products/fulltags/DESIGN-NOTES.md`                                                                                                                                                                                                                                                                                                                                                          | grep "setbuild" — update if present                                                                                                                                                                                                                             |
| **Comment-only mentions (C1 ride-along):** `src/getdat/commands/adopt.ts:132`, `src/fulltags/cues.ts:11`, `cratedeck/src/archive.ts:64,674`, `cratedeck/web/ui/data.tsx:7`, `cratedeck/web/styles/data.css:101` (comment), `src/shared/maintenance-cmds.ts:356` (comment), `cratedeck/shared/camelot.ts:3` (comment), `docs/set/03-competitive-analysis.md:208` (`the setbuild call` → `the megaset call`) | rewrite wording while renaming                                                                                                                                                                                                                                  |
...
| `src/deck/test/archive-setbuild-surface.test.ts` (whole file) | tool key `archive_set_build`, route URLs ×4, tmpdir prefixes, local type names; **rename the file too**                                                                                                                     |
| `src/deck/test/setbuild.test.ts` (renamed in C1)              | every import + `describe("parseSetbuildQuery")`                                                                                                                                                                             |
| `src/rekordbox/rb-playlist.test.ts`                            | 4 mentions — default playlist name + import path                                                                                                                                                                            |
| `src/deck/web/test/fulltags-similar-ux.test.tsx`              | CSS class regexes (`setbuild-preset-option` ×3-count, `setbuild-build`, `setbuild-preset-arc`, `setbuild-preset-label`), route string `"/api/archive/setbuild?"`, `SetBuildPayload`/`SetBuilderResult` imports              |
| `src/deck/test/mcp-protocol.test.ts`                          | tools/list census — verify whether tool names are asserted individually (grep in C2; count-pins survive a rename, name-pins flip)                                                                                           |
...
| `src/deck/test/camelot.test.ts`                               | comment only — ride along                                                                                                                                                                                                   |
...
- Update **every importer** to new paths/names: `src/deck/shared/types.ts`

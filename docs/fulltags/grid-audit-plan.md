...
| Asset                                 | Where                                                                                                                             | State                                                                                                                                                                                       |
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Beat + downbeat arrays, whole archive | `megadj beats` → `beats` table (`src/fulltags/analysis/beats.ts`, `src/archive/state_core.ts`)                                             | Ledgered and idempotent; live coverage comes from `megadj status --json`. beat_this v1.1.0, MIT, **peak-picking (no DBN), device=cpu**                                                      |

...
| -------------------- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `archive.db`         | GetDat pipeline state and FullTags/Set analysis ledgers                               | [`src/archive/state_core.ts`](../../src/archive/state_core.ts) plus the extension producers listed below                                     | megadj owns writes; CrateDeck opens its archive view read-only                                                      |

/**
 * Remix/bootleg detection from filenames — ingest-time metadata enrichment.
 * Bootlegs rarely have MusicBrainz entries, so filename structure
 * (`Artist - Track (Remixer Remix)`) is the best source for the

...
//
// Split per concern (#233, the #209 pattern): the census table + track
// picker + verdict wiring stay here; the three-source compare card and
// its per-field rows live in TagCompareRows.tsx.
...
import { CompareCard, CompareInline, diffPill, show } from "./TagCompareRows";

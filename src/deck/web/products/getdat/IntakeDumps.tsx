...
// the strip's row type is DERIVED from the owner leaf (#262 contract),
// through the same barrel the census shape rides — never copied
import type { DumpRecord } from "../../../shared/dump";
...
export function IntakeDumps() {
  ...
  const dumpRows: DumpRecord[] = rows;

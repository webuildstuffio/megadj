...
import { errMessage, fmtBytes, timeAgo } from "../../../../shared/leaf/fmt";
      ...
      <div class="archive-cols">
        ...
        <div class="card">
          <ListHead
            ...
            title="Years"
            n={lib.years.known}
            hint="Release-year coverage. The year is THIS file's version (a 2026 edit of a 2003 original stamps 2026). Unknown years are a `megadj years` pass."
            lines={[
          ...
          <div class="arch-fix">
            fix: <code>megadj years</code> verifies AI-guessed years
          </div>
        </div>
        <div class="card">
          <ListHead

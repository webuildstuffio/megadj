...
import { pyUvArgv } from "./rb-python-file.js";
...
// renderer + argv helpers moved to rb-python-file.ts (the corpus-spawn
// leaf, Sep 21 cycle break); re-exported so kit stays the one import site
// for every rb-* caller.
export { renderKitMarkers, pyUvFileArgv } from "./rb-python-file.js";

// dedupe-types.ts — the wire types for the shelf twin-dedupe pass.
// Leaf seam (AGENTS.md split rule): dedupe.ts (the command) and
// dedupe-verdict.ts (the split-out judge/apply) both use these; the

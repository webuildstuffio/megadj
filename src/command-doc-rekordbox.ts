...
export const REKORDBOX_COMMAND_DOCS: readonly CommandDocEntry[] = [
  ...
  },
  {
    ...
    group: "fulltags",
    block: [
      "  megadj rb-playlist [drive] reconcile [--group NAME] [--all] [--apply --yes] [--json]",
      "                                               XML-twin healer (F7): find",
      "                                               djmdPlaylist rows missing their",
      "                                               masterPlaylists6.xml NODE (RB7",
      "                                               stores Ids as HEX — decimal",
      "                                               matches lie); scoped to the",
      "                                               agent-written groups by default",
      "                                               (DJ-Imports, MegaSets + --group),",
      "                                               --all diffs the whole DB; apply",
      "                                               adds the missing NODEs with",
      "                                               backups (dry first)",
    ],
  },
  {
    ...
    block: [
      ...
      "                                               [--genre FAMILY] [--search greedy|beam]",
      "                                               [--apply --yes] [--json]",

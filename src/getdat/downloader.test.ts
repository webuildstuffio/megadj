...
// ---- parser/error-classify coverage, absorbed from the orphaned
// src/downloader.test.ts (#234 — the #23 move left it at src/ root
// importing across dirs; its subject lives here).

...
import { normalizeGenre } from "../fulltags/genre/genre-vocab";
import {
  evalLeaveOneOut,
...
/** Two coherent genre clusters (house + techno, 9 rows each) — the
 *  shared population both LOO harnesses evaluate (jscpd, issue #223). */
const cluster = (
  prefix: string,
  genre: string,
  center: number[],

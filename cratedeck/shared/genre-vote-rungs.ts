...
export interface GenreVoteRungDef {
   ...
   *  (cratedeck/test/genre-vote-rungs-census.test.ts) pins every value
...
/** Run-scope constants for the explain surfaces. */
export const GENRE_VOTE_RUNG_COUNT = GENRE_VOTE_RUNG_DEFS.length;

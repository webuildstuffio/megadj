 ...
 *  UI renders the picker + descriptions from this table. A hand-copied
 *  twin drifted once (the UI labeled a preset the engine didn't know);
 *  census tests now derive every preset string from here.
 *  Envelopes: arousal on the 1–9 mood scale, danceability on 0–1;
 *  [start, end] = the arc's target at the first/last slot. */

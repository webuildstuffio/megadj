...
const P: Record<string, string> = {
  ...
  copy: "M8.5 8.5V5.6A1.6 1.6 0 0 1 10.1 4h8.3A1.6 1.6 0 0 1 20 5.6v8.3a1.6 1.6 0 0 1-1.6 1.6h-2.9M4 10.1A1.6 1.6 0 0 1 5.6 8.5h8.3a1.6 1.6 0 0 1 1.6 1.6v8.3a1.6 1.6 0 0 1-1.6 1.6H5.6A1.6 1.6 0 0 1 4 18.4v-8.3Z",
  doc: "M6 3.5h8L19 8.5v12a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-16a1 1 0 0 1 1-1Zm8 0v5h5M8.5 13h7m-7 4h5",

...
// Metric extraction lives in parse-metrics.ts (#88 item 1) —
// this file is check ASSEMBLY only.
import { VERIFY_HELP } from "./help";
import type { VerifyCheck, VerifyReport } from "../../shared/types";
import { lastLines } from "./report";
import { extractVerifyMetrics } from "./parse-metrics";

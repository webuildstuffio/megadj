/**
 * fetch_ai.ts — OpenRouter helpers for the fetch pipeline:
 * genre classification (+ optional remix-year estimation) and the album
 * naming heuristic for pack tracks.
 */
import { basename } from "node:path";
import { AI_MODEL, type Row } from "./fetch_lib";
 ...
 * NOTE: flash-lite tends to guess 2023 — verify years with fix_years.ts. */
